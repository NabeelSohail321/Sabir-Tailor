...
import '../Login.dart';
import '../NewClient/Coat.dart';
import '../NewClient/ShalwarQamiz.dart';
import '../NewClient/Waskit.dart';
import 'ShowMeasurements/PantsData.dart';
import 'ShowMeasurements/ShalwarQamizData.dart';
import 'ShowMeasurements/Waskit Data.dart';
import 'ShowMeasurements/coatData.dart';
import 'ShowMeasurements/sherwani data.dart';


class ExistingClientDashboard extends StatefulWidget {
  const ExistingClientDashboard({super.key});

  @override
  State<ExistingClientDashboard> createState() => _ExistingClientDashboardState();
}

class _ExistingClientDashboardState extends State<ExistingClientDashboard> {
  User? currentUser;
