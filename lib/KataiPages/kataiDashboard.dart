...
import '../Login.dart';
import '../drawer.dart';
import 'Katai Orders.dart';




class kataidashBoard extends StatefulWidget {
  const kataidashBoard({super.key});

  @override
  State<kataidashBoard> createState() => _kataidashBoardState();
}

class _kataidashBoardState extends State<kataidashBoard>  with SingleTickerProviderStateMixin  {
  User? currentUser;
  String? adminId;
  String? adminNumber;
  String? role;
