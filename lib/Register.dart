...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void RegisterUser() async {
    ...
    try {
      ...
      if (!isAdminAvailable) {
        ...
        // Register as employee with the selected role (1 for Silai, 2 for Katai)
        // await _registerEmployee(uid, employeeRef, selectedRole);
        // ScaffoldMessenger.of(context).showSnackBar(
  ...
  // Future<void> _registerEmployee(String uid, DatabaseReference employeeRef, String role) async {
